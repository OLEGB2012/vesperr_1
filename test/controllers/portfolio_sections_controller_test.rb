...
class PortfolioSectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create portfolio_section" do
    assert_difference('PortfolioSection.count') do
      post portfolio_sections_url, params: { portfolio_section: { description: @portfolio_section.description, section_id: @portfolio_section.section_id } }
    end
  ...
  test "should update portfolio_section" do
    patch portfolio_section_url(@portfolio_section), params: { portfolio_section: { description: @portfolio_section.description, section_id: @portfolio_section.section_id } }
